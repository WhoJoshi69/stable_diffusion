...
def createPrompts(promptCount):
    ...
    for i in range(promptCount):
        ...
        prompts = prompts + "("                  + getRandomStringFromList(place)                  + ":"                  + "{:.2f}".format(random.uniform(lower_bound, multiplier))                  + ") "                  + "("                  + getRandomStringFromList(beautifier)                  + ":"                  + "{:.2f}".format(random.uniform(lower_bound, multiplier))                  + ") "                  + "("                  + getRandomStringFromList(type)                  + ":"                  + "{:.2f}".format(random.uniform(lower_bound, multiplier))                  + ") "                  + "girl with "                  + "("                  + getRandomStringFromList(bSize)                  + ":"                  + "{:.2f}".format(random.uniform(lower_bound, multiplier))                  + ") "                  + "and " + "("                  + getRandomStringFromList(bSize)                  + ":"                  + "{:.2f}".format(random.uniform(lower_bound, multiplier))                  + ") "                  + "("                  + getRandomStringFromList(hairLength)                  + ":"                  + "{:.2f}".format(random.uniform(lower_bound, multiplier))                  + " "                  + getRandomStringFromList(hairColor)                  + ":"                  + "{:.2f}".format(random.uniform(lower_bound, multiplier))                  + ") "                  + "and "                  + "("                  + getRandomStringFromList(eyeColor)                  + " eyes:"                  + "{:.2f}".format(random.uniform(lower_bound, multiplier))                  + ") "                  + "wearing "                  + "("                  + getRandomStringFromList(accessory)                  + ":"                  + "{:.2f}".format(random.uniform(lower_bound, multiplier))                  + ") "                  + "("                  + getRandomStringFromList(style)                  + ":"                  + "{:.2f}".format(random.uniform(lower_bound, multiplier))                  + ") "                  + "with "                  + "("                  + getRandomStringFromList(perp)                  + ":"                  + "{:.2f}".format(random.uniform(lower_bound, multiplier))                  + ") "                  + "("                  + getRandomStringFromList(expression)                  + ":"                  + "{:.2f}".format(random.uniform(lower_bound, multiplier))                  + ") "                  + "(nsfw:"                  + "{:.2f}".format(random.uniform(lower_bound, multiplier))                  + ") "                  + "(penetration:"                  + "{:.2f}".format(random.uniform(lower_bound, multiplier))                  + ") "                  + "(perfect face:"                  + "{:.2f}".format(random.uniform(lower_bound, multiplier))                  + ") "                  + "(perfect fingers:"                  + "{:.2f}".format(random.uniform(lower_bound, multiplier))                  + ") "                  + "("                  + getRandomStringFromList(artists)                  + ":"                  + "{:.2f}".format(random.uniform(lower_bound, multiplier))                  + ") "                  + "("                  + getRandomStringFromList(artists)                  + ":"                  + "{:.2f}".format(random.uniform(lower_bound, multiplier))                  + ") "                  + "("                  + getRandomStringFromList(artists)                  + ":"                  + "{:.2f}".format(random.uniform(lower_bound, multiplier))                  + ") "                  + "("                  + getRandomStringFromList(artStyle)                  + ":"                  + "{:.2f}".format(random.uniform(lower_bound, multiplier))                  + ") "                  + "("                  + getRandomStringFromList(details)                  + ":"                  + "{:.2f}".format(random.uniform(lower_bound, multiplier))                  + ") "                  + "\n"
